...
export default class TestCaseTest extends TestCase {
    ...
    it_asserts_the_instance_of_an_object() {
        ...
        this.assertInstanceOf('Apple', apple);

        try {
            this.assertInstanceOf('Banana', apple);
        } catch (e) {
            this.failed = true;
            this.assertSame('AssertionError', e.constructor.name);
        }
    ...
    it_asserts_the_count_of_elements_in_array() {
        ...
        try {
            ...
            this.failed = true;
            this.assertInstanceOf('AssertionError', e);
        }
    ...
    /** @test */
    it_asserts_that_element_is_null() {
    ...
    /** @test */
    it_asserts_that_element_is_not_null() {
